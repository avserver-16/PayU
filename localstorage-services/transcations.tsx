 ...
 * finances.tsx
 *
 * Local storage service for personal finance tracking.
 * Handles net worth, income/expense transactions, credit score,
 * and 5-day data projection based on user inputs.
 *
 * Uses expo-secure-store with in-memory fallback.
...
/**
 * Call once when user first sets up their finances.
 * Saves net worth, currency, and monthly estimates.
 * Auto-generates the first 5-day timeline.
 */
